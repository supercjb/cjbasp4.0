...
<%end if%>
<center>
  <form method="POST" action="poll_action.asp" name="InputForm">
...
If rsset("UBBcode") =False Then %>不<%End If%>開啟，請看</font><font size="2"><a target="_blank" href="help_ubb.htm"><font color="#B88810">UBB幫助</font></a></font><font size="2" color="#B88810">)&nbsp;&nbsp; 
		...
		<tr>                        
			...
			<font size="2">&nbsp; 選項1</font><input type="text" name="T1" size="20"><font size="2">&nbsp;&nbsp; 
			選項2</font><input type="text" name="T2" size="20"></p>
			<p align="left" style="margin-top: 0; margin-bottom: 0">
			<font size="2">&nbsp; 選項3</font><input type="text" name="T3" size="20"><font size="2">&nbsp;&nbsp; 
			選項4</font><input type="text" name="T4" size="20"></p>
			<p align="left" style="margin-top: 0; margin-bottom: 0">
			<font size="2">&nbsp; 選項5</font><input type="text" name="T5" size="20"><font size="2">&nbsp;&nbsp; 
			選項6</font><input type="text" name="T6" size="20"></p>
			<p align="left" style="margin-top: 0; margin-bottom: 0">
			<font size="2">&nbsp; 選項7</font><input type="text" name="T7" size="20"><font size="2">&nbsp;&nbsp; 
			選項8</font><input type="text" name="T8" size="20"></p>
			<p align="left" style="margin-top: 0; margin-bottom: 0">
			<font size="2">&nbsp; 選項9</font><input type="text" name="T9" size="20"><font size="2"> 
			選項10</font><input type="text" name="T10" size="20"><font size="2"> 
			(沒有請留白)</font></p>
